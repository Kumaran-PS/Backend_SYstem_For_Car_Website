...
@ApiResponses(value = {
        ...
        @ApiResponse(code=401, message = "No authorization due to security reasons."),
        @ApiResponse(code=500, message = "Server is down.Please try after some time and make sure microservice is running."),
})
@RequestMapping("/cars")
class CarController {
